...
#    :param str sku: Marketplace image sky
    ...
    new_pool = azurebatch.models.PoolAddParameter(
        ...
        start_task=batchmodels.StartTask(
            command_line="cmd /c starttask.cmd && python-3.7.6-amd64.exe /quiet InstallAllUsers=1 PrependPath=1 Include_test=0",
...
def add_tasks(batch_service_client, job_id, input_files, output_container_sas_url):
    ...
    """
    # See also https://techcommunity.microsoft.com/t5/azure-paas-blog/install-python-on-a-windows-node-using-a-start-task-with-azure/ba-p/2341854
